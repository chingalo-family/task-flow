...
class AddStatusContainer extends StatefulWidget {
  const AddStatusContainer({super.key});

  @override
  State<AddStatusContainer> createState() => _AddStatusContainerState();
}

class _AddStatusContainerState extends State<AddStatusContainer> {
  final TextEditingController _nameController = TextEditingController();
  Color _selectedColor = const Color(0xFF2E90FA);
